...
var Step1Scene = cc.Scene.extend({
    ...
    code: function () {
        var codeSprite = this.codeSprite = new cc.Sprite(res.step1Code, cc.rect(0, 0, 335, 335));
    ...
    codeAction: function () {
        ...
        if (this.codeSpriteTrue.height <= 0) {
            this.codeSprite.y = 862;
            this.codeSpriteTrue.height = 335;
        }
